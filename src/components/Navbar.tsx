  ...
  return (
    <nav className="w-full border-b border-gray-800 bg-charcoal-dark/80 backdrop-blur-md sticky top-0 z-50">
      <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-2 border border-gray-700 bg-charcoal-light px-3 py-1 rounded-full cursor-pointer hover:border-gray-500 transition">
